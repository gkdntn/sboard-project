...
public class SecurityConfig {
    ...
    /*
        ...
        인가설정
        - MyUserDetails의 사용자 권한 목록을 제공하는 getAuthorities()에서 반드시 접두어로 ROLE_ 을 붙여야 한다.
        - ROLE_ 접두어를 안붙이면 hasAuthority(), hasAnyAuthority()로 권한 설정하기!
        - 존재하지 않은 요청주소에 대해서 시큐리티는 로그인페이지로 기본 redirect 수행하기 때문에
          마지막 anyRequest().permitAll() 권한설정을 해야한다!
     */
